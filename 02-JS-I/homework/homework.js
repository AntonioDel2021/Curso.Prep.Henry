...
function multiplica(x, y) {var multiplicacion = x*y;return multiplicacion ;
  // Multiplica "x" por "y" y devuelve el valor
  // Tu código:
}

function divide(x, y) {var division = x/y;return division;
...
function esVocal(letra){
  if (letra.length > 1){
  return "Dato incorrecto"}; if (letra === "a" || letra === "e" || letra === "i" || letra === "o" || letra === "u") {return "Es vocal"} else {return "Dato incorrecto"}
